...
docker run -t \
        ...
        --name cloudmapper \
        cloudmapper
docker exec -t cloudmapper python cloudmapper.py collect --account $aws_account_name
docker exec -t cloudmapper python cloudmapper.py report --account $aws_account_name
docker exec -t cloudmapper python cloudmapper.py prepare --account $aws_account_name
docker exec -t cloudmapper python cloudmapper.py webserver --public
